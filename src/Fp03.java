...
public class Fp03 {
    ...
    public static void buyukHarfleYazdir(List<String> list){
        ...
        list.stream().map(String::toUpperCase).forEach(Utilss::ayniSatirdaBosluklaYazdir);
    }
    //2. Yol
...
//    }
    ...
    public static void uzunlugaGoreYazdir(List<String> list){
        ...
        list.
                ...
                forEach(Utilss::ayniSatirdaBosluklaYazdir);//Comparator.comparing(): Sıralama koşulun belirtmek için kullanılır.
    ...
    public static void uzunlugaGoreTersYazdir(List<String> list){
        ...
        list.
                ...
                forEach(Utilss::ayniSatirdaBosluklaYazdir);
    }
    ...
    public static void sonKaraktereGoreTekrarsizYazdir(List<String> list){
        ...
        list.stream().distinct().sorted(Comparator.comparing(Utilss::sonKarakteriAl)).forEach(Utilss::ayniSatirdaBosluklaYazdir);
    }
    ...
    public static void uzunlukVeIlkHarfeGoreSiralaYazdir(List<String> list){
        ...
        list.
                stream().
                sorted(Comparator.comparing(String::length).thenComparing(Utilss::ilkKarakteriAl)).//thenComparing() :==>siralama icin bir kosul daha belirtir
                forEach(Utilss::ayniSatirdaBosluklaYazdir);
